...
const level: Level = {
  id: "world3-level5",
  title: "Speed Demon",
  description: "A turbocharged Am pentatonic run that dips, rises, and loops back with an unexpected high C4 finish. Stamina and precision are the final tests.",
  bpm: 130,
  notes: [
    ...
    { id: "n12", string: 4, fret: 0, targetFrequency: 146.83, durationBeats: 1, startBeat: 11 },
    { id: "n13", string: 4, fret: 2, targetFrequency: 164.81, durationBeats: 1, startBeat: 12 },
    { id: "n14", string: 3, fret: 0, targetFrequency: 196.00, durationBeats: 1, startBeat: 13 },
    { id: "n15", string: 3, fret: 2, targetFrequency: 220.00, durationBeats: 1, startBeat: 14 },
    { id: "n16", string: 3, fret: 5, targetFrequency: 261.63, durationBeats: 1, startBeat: 15 },
  ],
};
